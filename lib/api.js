...
module.exports = {
    ...
    obterConversaoMoeda: async (moeda, valor)=>{
        try {
            const moedasSuportadas = ['dolar','euro', 'real', 'bitcoin']
            ...
            switch(moeda){
                ...
                case 'real':
                    ...
                    break
                case 'bitcoin':
                    moeda = (valor > 1) ? "Bitcoin" : "Bitcoins"
                    params = "BTC-USD,BTC-BRL,BTC-EUR"
                    break                 
            }
    ...
    blayTeste: async()=>{
        const textoBlay = await axios.get("https://gist.githubusercontent.com/brelins/93df0a1aa4b16baafab8a2245fea0f75/raw/040410cbda76160a574d50cbbef8daddcf29b5c3/gistfile1.txt")
        return textoBlay.data
    },
